...
public class PlayerOneBulletWeapon : MonoBehaviour 
{
	...
	void Update () 
	{
		...
		if(Input.GetKeyDown(KeyCode.Space) && (mineWeapon == true || missileWeapon == true))
		{	
			basicWeapon = true; 
			mineWeapon = false; 
			missileWeapon = false;
		...
		if(Input.GetKeyDown(KeyCode.Alpha2) && (basicWeapon == true || missileWeapon == true))
		{
			basicWeapon = false; 
			mineWeapon = true; 
			missileWeapon = false;
		...
		if(Input.GetKeyDown(KeyCode.Alpha1) && (mineWeapon == true || basicWeapon == true))
		{
			basicWeapon = false; 
			mineWeapon = false; 
			missileWeapon = true;
	...
	void ShootMine()
	{
		if(Input.GetKeyDown(KeyCode.Alpha2) && canAttackMine && mineAmmo > 0)
		{
	...
	void ShootMissile()
	{
		if(Input.GetKeyDown(KeyCode.Alpha1) && canAttackMissile && missileAmmo > 0)
		{
