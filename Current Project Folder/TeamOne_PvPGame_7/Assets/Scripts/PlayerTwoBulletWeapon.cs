...
public class PlayerTwoBulletWeapon : MonoBehaviour 
{
	...
	void Update () 
	{
		...
		if(Input.GetKeyDown(KeyCode.Keypad1) && (mineWeapon == true || missileWeapon == true))
		{	
			basicWeapon = true; 
			mineWeapon = false; 
			missileWeapon = false;
		...
		if(Input.GetKeyDown(KeyCode.Keypad2) && (missileWeapon == true || basicWeapon == true))
		{
			basicWeapon = false; 
			mineWeapon = true; 
			missileWeapon = false;
			...
			if(Input.GetKeyDown(KeyCode.Keypad3) && (mineWeapon == true || basicWeapon == true))
		{
			basicWeapon = false; 
			mineWeapon = false; 
			missileWeapon = true;
	...
	void ShootBasic()
	{
		if(Input.GetKeyDown(KeyCode.Keypad1) && canAttackBasic)
		{
	...
	void ShootMine()
	{
		if(Input.GetKeyDown(KeyCode.Keypad2) && canAttackMine && mineAmmo > 0)
		{
	...
	void ShootMissile()
	{
		if(Input.GetKeyDown(KeyCode.Keypad3) && canAttackMissile && missileAmmo > 0)
		{
